...
public class FragranceProvider extends ContentProvider {
    ...
    /**
     * URI matcher code for the content URI for the cleaner table
     */
    private static final int CLEANER = 106;

    /**
     * URI matcher code for the content URI for a single cart in the cleaner table
     */
    private static final int CLEANER_ID = 107;
    ...
    static {
        ...
        sUriMatcher.addURI(FragranceContract.CONTENT_AUTHORITY, FragranceContract.PATH_CLEANER, CLEANER);
        ...
        sUriMatcher.addURI(FragranceContract.CONTENT_AUTHORITY, FragranceContract.PATH_CLEANER + "/#", CLEANER_ID);
    ...
    public Cursor query(@NonNull Uri uri, @Nullable String[] projection, @Nullable String selection, @Nullable String[] selectionArgs, @Nullable String sortOrder) {
        ...
        switch (match) {
            ...
            case WISH:
                ...
                break;
            case CLEANER:
                cursor = database.query(FragranceContract.FragranceEntry.CLEANER_TABLE, projection, selection, selectionArgs,
                        null, null, sortOrder);
                break;
            ...
            case CLEANER_ID:
                selection = FragranceContract.FragranceEntry._CLEANER + "=?";
                selectionArgs = new String[]{String.valueOf(ContentUris.parseId(uri))};
    ...
    public int delete(@NonNull Uri uri, @Nullable String s, @Nullable String[] strings) {
        ...
        switch (match) {
            ...
            case CLEANER_ID:
                // Get the task ID from the URI path
                String CleanerId = uri.getPathSegments().get(1);
                // Use selections/selectionArgs to filter for this ID
                cartDeleted = db.delete(FragranceContract.FragranceEntry.WISH_TABLE, "_id=?", new String[]{CleanerId});
                break;
            default:
