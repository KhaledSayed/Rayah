...
public class CleanerProduct {
    ...
    public CleanerProduct(String mNames, String mImageUrl, String mImageIcon, int mTextPrice, String desName, String desSupname, int desPrice, String desDescraption, int desRating, String desProductionDate, String desExpiredate, int desSize, String companyName, String desOrginCountry) {
        this.mNames = mNames;
