...
public class CartAdapter extends RecyclerView.Adapter<CartAdapter.CartViewHolder> {
    ...
    public void onBindViewHolder(CartViewHolder holder, int position) {
        ...
        int productIdIndex = mCursor.getColumnIndex(FragranceContract.FragranceEntry.COLUMN_CART_PRODUCT_ID);
        ...
        String productId = mCursor.getString(productIdIndex);
        ...
        holder.fragPrice.setText("L.E" + precision.format(fragrancePrice));

        String poster = fragranceImage;

        Glide.with(mContext)
                .load(BaseUrl.baseImageUrl+poster)
                .apply(new RequestOptions().placeholder(R.drawable.load))
                .into(holder.image);

        Log.d("Khaled", "onBindViewHolder: "+productId);
    }
