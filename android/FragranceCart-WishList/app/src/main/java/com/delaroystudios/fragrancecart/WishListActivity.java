...
public class WishListActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    public Loader<Cursor> onCreateLoader(int i, Bundle bundle) {
        String[] projection = {
                ...
                FragranceContract.FragranceEntry.COLUMN_WISH_SUPNAME,
                ...
                FragranceContract.FragranceEntry.COLUMN_WISH_COMPANYNAME,
                FragranceContract.FragranceEntry.COLUMN_WISH_PRODUCTIONDATE,
                FragranceContract.FragranceEntry.COLUMN_WISH_EXPIREDATE,
                FragranceContract.FragranceEntry.COLUMN_WISH_SIZE,
                FragranceContract.FragranceEntry.COLUMN_WISH_COUNTRY
