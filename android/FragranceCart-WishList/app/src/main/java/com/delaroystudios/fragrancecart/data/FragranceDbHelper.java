...
public class FragranceDbHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        final String SQL_CREATE_CART_FRAGRANCE_TABLE = "CREATE TABLE " + FragranceContract.FragranceEntry.CART_TABLE + " (" +
                ...
                FragranceContract.FragranceEntry.COLUMN_CART_PRODUCT_ID+" TEXT NOT NULL  );";

        final String SQL_CREATE_WISHLIST_LRAHTAK_TABLE = "CREATE TABLE " + FragranceContract.FragranceEntry.WISH_TABLE + " (" +
                ...
                FragranceContract.FragranceEntry.COLUMN_WISH_SUPNAME + " TEXT NOT NULL, " +
                ...
                FragranceContract.FragranceEntry.COLUMN_WISH_COMPANYNAME + " TEXT NOT NULL, " +
                FragranceContract.FragranceEntry.COLUMN_WISH_PRODUCTIONDATE + " TEXT NOT NULL, " +
                FragranceContract.FragranceEntry.COLUMN_WISH_EXPIREDATE + " TEXT NOT NULL, " +
                FragranceContract.FragranceEntry.COLUMN_WISH_SIZE + " TEXT NOT NULL, " +
                FragranceContract.FragranceEntry.COLUMN_WISH_COUNTRY + " TEXT NOT NULL, " +
                FragranceContract.FragranceEntry.COLUMN_WISH_USERRATING + " TEXT NOT NULL " + " );";

        final String SQL_CREATE_CLEANER_TABLE = "CREATE TABLE " + FragranceContract.FragranceEntry.CLEANER_TABLE + " (" +
                FragranceContract.FragranceEntry._ID + " INTEGER PRIMARY KEY AUTOINCREMENT," +
                FragranceContract.FragranceEntry.COLUMN_NAME_CLEANER + " TEXT UNIQUE NOT NULL, " +
                FragranceContract.FragranceEntry.COLUMN_DESCRIPTION_CLEANER + " TEXT NOT NULL, " +
                FragranceContract.FragranceEntry.COLUMN_IMAGE_CLEANER + " TEXT NOT NULL, " +
                FragranceContract.FragranceEntry.COLUMN_PRICE_CLEANER + " REAL NOT NULL, " +
                FragranceContract.FragranceEntry.COLUMN_USERRATING_CLEANER + " INTEGER NOT NULL " + " );";


        db.execSQL(SQL_CREATE_FRAGRANCE_TABLE);
        db.execSQL(SQL_CREATE_CART_FRAGRANCE_TABLE);
        db.execSQL(SQL_CREATE_WISHLIST_LRAHTAK_TABLE);
        db.execSQL(SQL_CREATE_CLEANER_TABLE);
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        db.execSQL("DROP TABLE IF EXISTS " + FragranceContract.FragranceEntry.CLEANER_TABLE);
        onCreate(db);
    }
    ...
    private void readFragrancesFromResources(SQLiteDatabase db) throws IOException, JSONException {
        ...
        try {
            ...
            for (int i = 0; i < fragranceArray.length(); i++) {
                ...
                fragranceValues.put(FragranceContract.FragranceEntry.COLUMN_NAME_CLEANER , fragranceName);
                fragranceValues.put(FragranceContract.FragranceEntry.COLUMN_DESCRIPTION_CLEANER , description);
                fragranceValues.put(FragranceContract.FragranceEntry.COLUMN_IMAGE_CLEANER , imageUrl);
                fragranceValues.put(FragranceContract.FragranceEntry.COLUMN_PRICE_CLEANER , price);
                fragranceValues.put(FragranceContract.FragranceEntry.COLUMN_USERRATING_CLEANER , userRating);

                db.insert(FragranceContract.FragranceEntry.CLEANER_TABLE, null, fragranceValues);
