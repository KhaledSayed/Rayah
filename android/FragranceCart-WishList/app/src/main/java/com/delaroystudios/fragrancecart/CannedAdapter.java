...
public class CannedAdapter extends RecyclerView.Adapter<CannedAdapter.ViewHolder> {
    Context cleaner_context;
    List<CannedProduct> data;

    public CannedAdapter(Context cleaner_context, List<CannedProduct> data) {
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, final int position) {
        ...
        SharedPreferences sharedFavorit = cleaner_context.getSharedPreferences("cannedlol", Context.MODE_PRIVATE);
        Boolean a = sharedFavorit.getBoolean("cannedabc" + position, false);
        ...
        holder.cleanerFavorite.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (isChecked) {
                    holder.cleanerFavorite.setBackgroundDrawable(ContextCompat.getDrawable(cleaner_context, R.drawable.toogel_favourit_true));
                    SharedPreferences.Editor editor = cleaner_context.getSharedPreferences("cannedlol", Context.MODE_PRIVATE).edit();
                    editor.putBoolean("cannedabc" + position, true);
                    editor.commit();
...
//                    Toast.makeText(cleaner_context, "done", Toast.LENGTH_SHORT).show();
                    ...
                    holder.cleanerFavorite.setBackgroundDrawable(ContextCompat.getDrawable(cleaner_context, R.drawable.toogel_ic_favourite));
                    SharedPreferences.Editor editor = cleaner_context.getSharedPreferences("cannedlol", Context.MODE_PRIVATE).edit();
                    editor.putBoolean("cannedabc" + position, false);
                    editor.commit();
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (pos != RecyclerView.NO_POSITION) {
                        ...
                        intent.putExtra(CLEANER_COUNTRY, data.get(pos).getDesOrginCountry());
