...
import { CategoryVm, CouponVm } from "src/app/api/models";
...
export class BrowseComponent implements OnInit {
    ...
    swal({
      ...
      if (result.value) {
        swal("Deleted!", "Your file has been deleted.", "success").then(
          result => {
            this._couponService.CouponDelete(category.id).subscribe(result => {
              this.getCoupon();
            });
  ...
  goToUpdate(category) {
    ...
    this.router.navigate(["coupons", "update", category.id]);
  }
}
